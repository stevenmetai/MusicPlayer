 ...
 */
public class AlbumAdapter extends BaseExpandListSwapAdapter {
    ...
    private void updateList() {
        while (mCursor != null && mCursor.moveToNext()) {
            ...
            if (!mGroupData.contains(album)) {
                mGroupData.add(album);
            }
            Music music = new MusicBuilder()
                    ...
                    .build();
            if (mChildData.containsKey(album)) {
                mChildData.get(album).add(music);
            } else {
                ArrayList<Music> list = new ArrayList<>();
                list.add(music);
                mChildData.put(album, list);
            }
        }
